...
alter table "public"."hyperboard_blueprint_metadata"
...
alter table "public"."hyperboard_blueprint_metadata"
    add constraint "hyperboard_blueprint_metadata_pkey" PRIMARY KEY using index "hyperboard_blueprint_metadata_pkey";

alter table "public"."hyperboard_blueprint_metadata"
    add constraint "hyperboard_blueprint_metadata_collection_id_blueprint_id_fkey" FOREIGN KEY (collection_id, blueprint_id) REFERENCES collection_blueprints (collection_id, blueprint_id) not valid;

alter table "public"."hyperboard_blueprint_metadata"
    validate constraint "hyperboard_blueprint_metadata_collection_id_blueprint_id_fkey";

alter table "public"."hyperboard_blueprint_metadata"
    add constraint "hyperboard_blueprint_metadata_collection_id_fkey" FOREIGN KEY (collection_id) REFERENCES collections (id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."hyperboard_blueprint_metadata"
    validate constraint "hyperboard_blueprint_metadata_collection_id_fkey";

alter table "public"."hyperboard_blueprint_metadata"
    add constraint "hyperboard_blueprint_metadata_hyperboard_id_fkey" FOREIGN KEY (hyperboard_id) REFERENCES hyperboards (id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."hyperboard_blueprint_metadata"
    validate constraint "hyperboard_blueprint_metadata_hyperboard_id_fkey";
