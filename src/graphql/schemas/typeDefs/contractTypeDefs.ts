...
class Contract extends BasicTypeDef {
    @Field(_ => EthBigInt, {nullable: true, description: "The ID of the chain on which the contract is deployed"})
    chain_id?: bigint | number | string;
    @Field({nullable: true, description: "The address of the contract"})
    contract_address?: string;
    @Field(_ => EthBigInt, {nullable: true, description: "The block number at which the contract was deployed"})
