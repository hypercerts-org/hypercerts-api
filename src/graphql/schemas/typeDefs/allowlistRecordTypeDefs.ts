...
class AllowlistRecord extends BasicTypeDef {
    ...
    @Field(() => EthBigInt, {
        nullable: true,
        description: "The token ID of the hypercert the claimable fraction belongs to"
    })
    token_id?: string;
    ...
    proof?: string[];
    @Field(() => EthBigInt, {nullable: true, description: "The number of units of the claimable fraction"})
    units?: bigint | number;
    @Field(() => EthBigInt, {nullable: true, description: "The total number of units held by the hypercert"})
