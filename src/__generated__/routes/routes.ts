...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/v1/allowlists',
            ...
            ...(fetchMiddlewares<RequestHandler>(AllowListController.prototype.createAllowList)),

            async function AllowListController_createAllowList(request: ExRequest, response: ExResponse, next: any) {
